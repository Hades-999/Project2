<%-- 
    Document   : Order.jsp
    Created on : Nov 29, 2019, 12:29:07 AM
    Author     : HP
--%>
...
<div class="w3-content" style="max-width:1200px;margin-top:100px">
  <div class="w3-row w3-padding-64" id="about">
      Your order is arriving at your address
      <table class="w3-table w3-striped">
        ...
        try
        {
            ...
            String query="select * from orders where address="+"'"+address+"'";
        ...
        <tr>
                ...
                <td><%out.print(add); %></td>
                <td><button class="btn" onclick="window.location.href = 'index2.htm';">Cancel</button></td>
        </tr>
        <%
            }
        %>
